...
instructions! {
    ...
    (Some(nontrapping_f32_on_stack), i32_trunc_sat_f32_s, TruncSat),
    (Some(nontrapping_f32_on_stack), i32_trunc_sat_f32_u, TruncSat),
    (Some(nontrapping_f64_on_stack), i32_trunc_sat_f64_s, TruncSat),
    (Some(nontrapping_f64_on_stack), i32_trunc_sat_f64_u, TruncSat),
    (Some(nontrapping_f32_on_stack), i64_trunc_sat_f32_s, TruncSat),
    (Some(nontrapping_f32_on_stack), i64_trunc_sat_f32_u, TruncSat),
    (Some(nontrapping_f64_on_stack), i64_trunc_sat_f64_s, TruncSat),
    (Some(nontrapping_f64_on_stack), i64_trunc_sat_f64_u, TruncSat),
